...
public class Problem230 {
    ...
    // we can also do this using the same algo as this method using heaps(as shown in method 3).
    ...
    private void inorder(TreeNode node, PriorityQueue<Integer> minheap){
        if (node == null) return ;
